...
seqInfo <- seqInfo %>% 
  ...
  mutate(assemblystatus = factor(assemblystatus, levels = c("Complete Genome","Chromosome","Contig","Scaffold"), 
         ...
         species_gr = factor(species_id, labels = 
                               c(rep("MDR clade",3),"C. auris","C. lusitaniae","D. hansenii",
                                 rep("parapsilosis clade",2), rep("albicans clade",3),
                                 "S. stipitis", rep("Saccharomycetaceae",6)))) %>% 
...
ggtree(gene.tree, ladderize = TRUE) + 
  ...
  scale_color_manual(name = "Clades",
                     values = c("MDR clade"   = "purple",
                                "C. auris"    = "plum2",
                                "C. lusitaniae" = "magenta", 
                                "D. hansenii" = "gray50",
                                "S. stipitis" = "steelblue",
                                "parapsilosis clade" = "salmon", 
                                "albicans clade" = "red", 
                                "Saccharomycetaceae" = "grey20")) +
  theme(text = element_text(size = 14))
ggsave("output/img/20210624-raxml-gene-tree-color.png", width = 7, height = 6)
```
...
sps.color <-  c("MDR clade" = "purple", "C. auris" = "plum2",
                "C. lusitaniae" = "magenta", "D. hansenii"  = "gray50",
                "S. stipitis" = "steelblue", "parapsilosis clade" = "salmon", 
                "albicans clade" = "red",  "Saccharomycetaceae" = "grey20")
ggtree(gene.tree.rec, ladderize = TRUE, branch.length = "none") + 
  ...
  theme(text = element_text(size = 14))
ggsave("output/img/20210624-reconciled-rearranged90-gene-tree-color.png", width = 9, height = 7)
```
...
sps.tree %>% 
  ...
  geom_tiplab(size = 3.5, fontface = "italic", offset = 0.1) + xlim(0,11) +
