...
# author: Bin He
# date: 2021-11-08
# title: blast NTD of Hil3
# use: sh blast-NTD-Hil3.sh
#########################
...
bioawk -c fastx '$name ~ /Hil3/{print ">"$name; print $seq}' ../input/B8441-homologs-NTD.fasta > ./query.fa
# parameters
base=../output/copynum-var/Hil3/Hil3-NTD.tblastn

# tblastn (assumes the blast+ package has been installed locally)
echo "tblastn Hil3 NTD sequence against C. auris genome sequences..."
tblastn -db ../input/blastdb/Cand_auris_strains -query query.fa -db_gencode 12 -evalue 1e-150 -seg "no" -max_hsps 2 -num_threads 4 -outfmt 11 -out $base.asn
