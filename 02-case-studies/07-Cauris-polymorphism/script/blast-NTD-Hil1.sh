...
base=../output/copynum-var/Hil1/Hil1-NTD.tblastn
...
tblastn -db ../input/blastdb/Cand_auris_strains -query $in -query_loc 12-327 -db_gencode 12 -evalue 1e-150 -seg "no" -max_hsps 2 -num_threads 4 -outfmt 11 -out $base.asn
