...
# date: 2021-11-16
# title: align-epa1
# use: qsub clustalo-align-epa1.sh
# modified: 
#   first step for epa
#----------------------
...
in=../input/cauris-four-strains-for-gene-tree-nog-epa.fasta
length=500
base=../output/gene-tree/cauris-four-strains-for-gene-tree-nog-epa
