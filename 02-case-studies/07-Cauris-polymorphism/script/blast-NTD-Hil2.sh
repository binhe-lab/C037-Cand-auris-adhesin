...
# author: Bin He
# date: 2021-04-29
# title: blast NTD of Hil2
# use: sh blast-NTD-Hil2.sh
#########################
...
bioawk -c fastx '$name ~ /Hil2/{print ">"$name; print $seq}' ../input/B8441-homologs-NTD.fasta > ./query.fa
# parameters
base=../output/copynum-var/Hil2/Hil2-NTD.tblastn
