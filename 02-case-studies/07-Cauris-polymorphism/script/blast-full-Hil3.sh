...
# author: Bin He
# date: 2021-11-07
# title: blast full Hil3
# use: sh blast-full-Hil3.sh
#########################
...
bioawk -c fastx '$name ~ /Hil3/{print ">"$name; print $seq}' ../input/B8441-homologs.fasta > ./query.fa
# parameters
base=../output/copynum-var/Hil3/Hil3-full.tblastn
