...
base=../output/copynum-var/Hil1/Hil1-full.tblastn
...
tblastn -db ../input/blastdb/Cand_auris_strains -query $in -db_gencode 12 -evalue 1e-160 -seg "no" -max_hsps 2 -num_threads 4 -outfmt 11 -out $base.asn
