...
# author: Bin He
# date: 2021-11-08
# title: blast NTD of Hil4
# use: sh blast-NTD-Hil4.sh
#########################
...
bioawk -c fastx '$name ~ /Hil4/{print ">"$name; print $seq}' ../input/B8441-homologs-NTD.fasta > ./query.fa
# parameters
base=../output/copynum-var/Hil4/Hil4-NTD.tblastn

# tblastn (assumes the blast+ package has been installed locally)
echo "tblastn Hil4 NTD sequence against C. auris genome sequences..."
