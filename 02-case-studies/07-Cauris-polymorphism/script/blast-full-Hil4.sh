...
# author: Bin He
# date: 2021-11-07
# title: blast full Hil4
# use: sh blast-full-Hil4.sh
#########################
...
bioawk -c fastx '$name ~ /Hil4/{print ">"$name; print $seq}' ../input/B8441-homologs.fasta > ./query.fa
# parameters
base=../output/copynum-var/Hil4/Hil4-full.tblastn

# tblastn (assumes the blast+ package has been installed locally)
echo "tblastn Hil4 full sequence against C. auris genome sequences..."
