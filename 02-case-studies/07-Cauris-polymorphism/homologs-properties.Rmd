...
tandem %>% filter(grepl("XP_028889033", name)) %>% write_tsv(file = "../XP_028889033_drawing/input/XP_028889033_tandem.tsv")
tandem.div %>% filter(grepl("XP_028889033", name)) %>% 
  write_tsv(file = "../XP_028889033_drawing/input/XP_028889033_tandem_div.tsv")
```

```{r plot_tandem_repeats, warning=FALSE, fig.height=7, fig.width=9}
# plot
