...
Translated to python3 by the following command, by Bin He 2020-08-21
$ 2to3 -w flexidot_v1.06.py
The original python2.7 script is saved as flexidot_v1.06_python2.7.py
"""
