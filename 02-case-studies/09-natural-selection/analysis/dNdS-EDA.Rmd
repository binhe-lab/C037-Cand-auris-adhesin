...
```{r}
dN <- list(
  YN = read.dist("../output/paml/Hil1-repeat-yn00/2YN.dN"),
  NG = read.dist("../output/paml/Hil1-repeat-ml/2NG.dN"),
  ML = read.dist("../output/paml/Hil1-repeat-ml/2ML.dN")
)
dS <- list(
  YN = read.dist("../output/paml/Hil1-repeat-yn00/2YN.dS"),
  NG = read.dist("../output/paml/Hil1-repeat-ml/2NG.dS"),
  ML = read.dist("../output/paml/Hil1-repeat-ml/2ML.dS")
)
t <- list(
  YN = read.dist("../output/paml/Hil1-repeat-yn00/2YN.t"),
  NG = read.dist("../output/paml/Hil1-repeat-ml/2NG.t"),
  ML = read.dist("../output/paml/Hil1-repeat-ml/2ML.t")
)
```
```{r}
omega <- list(
...
df.YN <- read_table("../output/paml/Hil1-repeat-yn00/rst1", col_names = header, col_types = "iiddddddddd")
