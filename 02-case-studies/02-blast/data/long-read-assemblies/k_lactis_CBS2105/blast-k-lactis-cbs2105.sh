...
# author: Bin He
# date: 2022-04-22
# title: blast NTD of XP_028889033 against K. lactis CBS2105
...
base=./K-lactis-CBS2105-Hil-homologs-blast

# make blast database
cat GCA_007993695.1_ASM799369v1_protein.faa.gz | gunzip -c | makeblastdb -in - -parse_seqids -dbtype prot -title K_lactis_CBS2105 -out ../blastdb/K_lactis_CBS2105

# blastp (assumes the blast+ package has been installed locally)
blastp -db ../blastdb/K_lactis_CBS2105 -query $in -evalue 1e-5 -seg "no" -max_hsps 2 -num_threads 4 -outfmt 11 -out $base.asn
