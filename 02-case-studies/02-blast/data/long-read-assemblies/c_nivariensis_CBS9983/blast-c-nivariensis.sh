...
db=C_nivariensis_CBS9983
base=./C-nivariensis-CBS9983-Hil-homologs-blast

# make blast database
cat GCA_017309295.1_JHU_Cniv_v1_genomic.fna.gz | gunzip -c | makeblastdb -in - -parse_seqids -dbtype nucl -title $db -out ../../blastdb/$db
