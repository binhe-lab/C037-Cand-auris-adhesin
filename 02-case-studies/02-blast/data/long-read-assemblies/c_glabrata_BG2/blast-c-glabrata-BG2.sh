...
base=./C-glabrata-BG2-Hil-homologs-blast

# make blast database
cat GCA_014217725.1_ASM1421772v1_protein.faa.gz | gunzip -c | makeblastdb -in - -parse_seqids -dbtype prot -title C_glabrata_BG2 -out ../blastdb/C_glabrata_BG2

# blastp (assumes the blast+ package has been installed locally)
blastp -db ../blastdb/C_glabrata_BG2 -query $in -evalue 1e-5 -seg "no" -max_hsps 2 -num_threads 4 -outfmt 11 -out $base.asn
