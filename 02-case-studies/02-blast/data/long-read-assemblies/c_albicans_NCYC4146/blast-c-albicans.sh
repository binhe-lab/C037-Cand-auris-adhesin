...
db=C_albicans_NCYC4146
base=./C-albicans-NCYC4146-Hil-homologs-blast

# make blast database
cat GCA_005890745.1_ASM589074v1_genomic.fna.gz | gunzip -c | makeblastdb -in - -parse_seqids -dbtype nucl -title $db -out ../../blastdb/$db
