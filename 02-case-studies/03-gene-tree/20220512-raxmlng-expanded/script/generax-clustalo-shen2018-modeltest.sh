...
# author: Bin He
# date: 2022-10-17
# use: qsub generax-clustalo-shen2018-modeltest.sh
#----------------------
...
mpiexec -np 56 generax --families families-clustalo-modeltest.txt --species-tree generax/species-tree-shen2018-wScer.nwk --rec-model UndatedDL --per-family-rates --prefix ../output/generax/generax-clustalo-modeltest-shen2018-wScer --max-spr-radius 5
