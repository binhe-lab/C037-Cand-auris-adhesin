...
out=../output/raxml-ng/${base}_VT_I_G4

# estimate the tree
/Users/bhe2/bin/raxml-ng-mpi --all --msa $align --model VT+I+G4 --seed 123 --threads auto --workers auto --bs-trees autoMRE --prefix $out
