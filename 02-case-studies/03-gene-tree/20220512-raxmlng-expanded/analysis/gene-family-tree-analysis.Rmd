...
p.tree0 <- ggtree(gene.tree, layout = "fan", size = 0.4) +# scale_y_reverse() +
...
scaleClade(p.tree, Mbic_clade, 0.2) %>% scaleClade(235, 0.8) %>% 
  collapse(Mbic_clade, mode = "min", fill = "darkgreen")
...
#p.tree.cnt
ggsave(paste0("../output/img/", gsub("-", "", Sys.Date()), "-species-tree-with-gains.png"), width = 6, height = 6.5)
```
