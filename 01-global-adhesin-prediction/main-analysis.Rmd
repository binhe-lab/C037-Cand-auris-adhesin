...
- There is one prominent exception: GVVIVT motif is present in a different protein, PIS58185 in B8441 (and its orthologs in the other strains). This protein is very interesting: it no longer has the PF11765 domain but otherwise shows a high degree of sequence similarity with 
