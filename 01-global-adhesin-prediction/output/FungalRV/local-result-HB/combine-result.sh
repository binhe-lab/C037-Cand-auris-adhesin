...
files=(C_albicans_GCF_000182965.3_ASM18296v3_protein.txt \
	   ...
	   C_glabrata_GCA_010111755.1_ASM1011175v1_protein.txt \
...
species=(C_albicans C_glabrata C_glabrata C_auris C_auris C_auris S_cerevisiae)
strains=(SC5314 CBS138 CBS138new B11220 B8441 B11221 S288C)
