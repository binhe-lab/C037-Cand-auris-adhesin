...
(echo "# dibasic motif frequency (RR|KK|KR|RK)" && echo "# <seq ID> <freq> <perc>") > dibasic_freq_all_predicted_adhesin_20200226.txt
...
(echo "# cysteine frequency" && echo "# <seq ID> <freq> <perc>") > cysteine_freq_all_predicted_adhesin_20200226.txt
